    ...
    !FYCR-DM-DR
    !Initialize the dark parameters
    P%xi_dark = 0.50
    P%t_dark = P%TCMB*P%xi_dark
    P%BBN_consistency = .true.
    P%m_DM_GeV = 100.0d0
    P%f_sidm = 0.99999
    do i_DM_DR=1,DM_DR_max_n 
       P%a_DM_DR(i_DM_DR) = 0.0d0
       P%b_DR_DR(i_DM_DR) = 0.0d0
       P%d_DM_DR(i_DM_DR) = 0.0d0
    end do
    do i_DM_DR=1,DM_DR_max_l
       P%alpha_DM_DR_l(i_DM_DR) = 1.0d0
       P%beta_DR_DR_l(i_DM_DR) = 1.0d0
    end do
