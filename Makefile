...
F90C     = gfortran
#ETHOSV1: modern-gfortran flags. -ffast-math removed on purpose: it assumes no
#NaN/Inf, which would defeat the zero-opacity guards (ETHOSV1-FIX #7/#8/#10).
FFLAGS =   -O2 -fopenmp -funroll-loops -ffree-line-length-none -fallow-argument-mismatch -w
#
